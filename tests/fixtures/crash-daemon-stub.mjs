#!/usr/bin/env node
// tests/fixtures/crash-daemon-stub.mjs
//
// A fleetd stand-in that crashes on startup WITHOUT ever binding its port,
// used by daemon-helper.test.mjs to drive startDaemon()'s startup-failure
...
} catch { /* the test's assertion target is the HOME dir itself */ }
