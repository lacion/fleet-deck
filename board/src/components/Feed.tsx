...
import { hhmmss, classifyTicker, stripTickerEmoji } from '../util.ts';
import type { TickerEntry, SpawnOrphan } from '../../../contracts/index.ts';

interface FeedProps {
  ticker: TickerEntry[] | null | undefined;
  orphans: SpawnOrphan[] | null | undefined;
}
...
export default function Feed({ ticker, orphans }: FeedProps) {
