...
const registry = new Map<string, QuestionHandle>();

export function registerQuestion(id: string, handle: QuestionHandle): () => void {
...
export function getQuestion(id: string): QuestionHandle | null {
