...
const NEUTRAL =
  'the terminal connection was refused before it opened — possible causes: the proxy is not forwarding WebSocket upgrades, the daemon is unreachable, or the board key was rejected (reopen the board from its ?t=… URL)';
 ...
 */
export function refusedUpgradeText(
  heldKey: boolean,
  daemonGates: boolean | null | undefined,
): string {
